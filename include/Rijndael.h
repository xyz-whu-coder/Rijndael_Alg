...
/**
 * Maybe we don't need those tables?
 * By the way, I think the tables in the book are wrong, according to the test...(?)
 * TODO: How to generate the Logtable and Alogtable,
 * so that I don't have to type them...
 */
...
// Seems to have the same result when changing Logtable[1] from 0 to 255...
...
static const word8 S_Box_Inverse[256] = {
 ...
 * |      |      |      |      |      |
 *
 * TODO: How is this table designed?
 */
